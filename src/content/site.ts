...
export const contactPage = {
  ...
  submitCopyLabel: "Copy brief",
  cannotSend: "This website cannot send mail until a public email is published.",
  copied: "The brief is on your clipboard — it was not submitted.",
  copyFailed: "Copy did not succeed. Keep the brief locally until an email is listed.",
  mailtoOpened: "Your mail client should open with the inquiry drafted.",
